...
@interface StarOtherInfoViewController ()

@end

@implementation StarOtherInfoViewController
...
- (NSDictionary *)requestPara
{
    ...
    NSDictionary *para = @{@"path": @"getOtherCollectList.json",
                           @"userid": @"109971",
                           @"page": page,
                           @"maxrow": self.maxrow};
